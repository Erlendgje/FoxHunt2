...
public class ScorePosition : MonoBehaviour {
	...
	void Start () {
		...
		this.GetComponent<RectTransform>().sizeDelta = new Vector2(this.transform.parent.GetComponent<RectTransform>().rect.width - 40, this.transform.parent.GetComponent<RectTransform>().rect.height / 5);
